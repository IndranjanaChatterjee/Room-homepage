...
export default function Nav() {
  ...
  return (
    <header className="absolute top-0 left-0 w-full bg-transparent p-[1.5rem]  font-['League_Spartan'] w-full flex flex-row justify-start md:gap-[1.5rem] gap-[0.5rem]">
      ...
      <nav className={`bg-transparent flex flex-row  justify-center items-center gap-[1.5rem] text-[#ffffff] md:hidden anidown ${
          mobile ? "block" : "hidden"
        } `}>
        <span className="flex flex-row justify-center w-full px-[0rem]"
          
        >
          
          <ul className="flex flex-row justify-start gap-[1.2rem] lowercase text-2xl text-[#ffffff]">
          <li className="hover:border-b-4 cursor-pointer transition-all durarion-500 ease-linear">Home</li>
            <li className="hover:border-b-4 cursor-pointer transition-all durarion-500 ease-linear">Shop</li>
            <li className="hover:border-b-4 cursor-pointer transition-all durarion-500 ease-linear">About</li>
            <li className="hover:border-b-4 cursor-pointer transition-all durarion-500 ease-linear">Contact</li>
